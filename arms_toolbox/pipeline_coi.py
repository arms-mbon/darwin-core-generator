...
class PipelineCOI(Pipeline):
    ...
    def run(self):
        ...
        print("Processing ",full_file_name)   
        ...
        #print("--->first ASV id  from tax assignments = >",df_pema_tax["amplicon"][0],"<") # otu id from the extended final table XXX 
        ...
        for rmsid in replicate_material_sample_ids:
            ...
            for _, row in df_pema_subset.iterrows():
                ...
                #print("--->current ASV id from extended = >",asvid_from_extended,"<") #XXX
                #print("for otu",row["OTU"]," get from the function ", self.get_dna_dna_sequence(row["OTU"], fasta)) #XXX
                ...
                try:
                    ...
                    #print("looking for id >",otuid,"<")
                    #print("in fasta",fasta["5bf628ac4fba228a03d81385a0527c21a50fa83c"])
